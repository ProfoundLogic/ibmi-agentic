...
-- ============================================================================
CREATE TABLE HYPSGCU (
  -- Keys (from LFs)
  GCGRP#  DECIMAL(9,0)  NOT NULL DEFAULT 0,   -- Shipment group number  (key)
  ...
  GCSHPV  CHAR(2)       NOT NULL DEFAULT '',  -- Ship-via code
  ...
  GCSTCT  CHAR(2)       NOT NULL DEFAULT '',  -- Sub-total count flag
...
LABEL ON TABLE HYPSGCU IS 'Shipment Group / Customer';
