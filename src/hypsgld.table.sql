...
-- ============================================================================
CREATE TABLE HYPSGLD (
  -- Keys (from LF)
  LDGRP#  DECIMAL(9,0)  NOT NULL DEFAULT 0,   -- Shipment group (key)
  LDTURN  DECIMAL(9,0)  NOT NULL DEFAULT 0,   -- Turnaround
  LDTSEQ  DECIMAL(3,0)  NOT NULL DEFAULT 0,   -- Tote sequence
  LDRSEQ  DECIMAL(5,0)  NOT NULL DEFAULT 0,   -- Record sequence
  LDLOT#  CHAR(10)      NOT NULL DEFAULT '',  -- Lot number
  LDSSCC  DECIMAL(20,0) NOT NULL DEFAULT 0,      -- SSCC barcode
...
LABEL ON TABLE HYPSGLD IS 'Shipment Group Lot Detail';
