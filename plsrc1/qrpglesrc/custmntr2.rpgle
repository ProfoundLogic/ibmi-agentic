     ...
     C                   exsr      sflbld
     C
     C                   when      (cfkey=enter) and (alias_for_ptname<>*blanks)
        setll alias_for_ptname custlf;
     C                   exsr      clrsf1
     C                   exsr      sflbld
        clear alias_for_ptname;
      *
      ...
      *
     C                   when      long_option_name = display
     C                   movel(p)  'Display'     mode
     C                   exfmt     panel2
     C                   eval      long_option_name = *blank
     C                   update    sfl1
      ...
      *
     C                   when      long_option_name = change
      ...
      *
     C                   when      long_option_name = delete
     C                   eval      rrn2 = rrn2 +1
     C                   write     sfl2
     C                   eval      *in74 = *on
     C                   update    sfl1
