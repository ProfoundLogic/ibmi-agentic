...
const SCREENS=[
 ...
 { name:'itmdetl', tpl:['gtitdd','itmdetl.ejs'], css:['gtcommon/gt-theme.css','gtitdd/itmdetl.css'],
   declared:['action','langpref','opername','msg','dsku','ddesc','ddept','duom','dcasepk','dweight',
     ...
     'dimg1','dimg2','dimg3','dimg4','dimg5','dimg6','dimg7','dimg8',
     'dcap1','dcap2','dcap3','dcap4','dcap5','dcap6','dcap7','dcap8',
     'dsrc1','dsrc2','dsrc3','dsrc4','dsrc5','dsrc6','dsrc7','dsrc8',
     'imgdata','locsfl'],
   data:(lang)=>({action:'',langpref:lang,opername:lang==='FR'?'Marie Tremblay':'James Okonkwo',
     msg:lang==='FR'?'Photo ajoutée à cet article.':'Photo added to this item.',
     dsku:'GROC-000004',
     ...
     /* Two catalogue images plus two operator photos -- the mix the carousel
        has to badge correctly. */
     dimg1:103,dimg2:104,dimg3:205,dimg4:206,dimg5:0,dimg6:0,dimg7:0,dimg8:0,
     ...
     dcap3:lang==='FR'?'Photo d\u2019entrepôt 2026-08-06':'Warehouse photo 2026-08-06',
     dcap4:lang==='FR'?'Photo d\u2019entrepôt 2026-08-06':'Warehouse photo 2026-08-06',
     dcap5:'',dcap6:'',dcap7:'',dcap8:'',
     dsrc1:'C',dsrc2:'C',dsrc3:'P',dsrc4:'P',
