...
-- ============================================================================
CREATE TABLE AITSK00030/HYPSGHD (
  -- Key
  GHGRP#   DECIMAL(7,0)  NOT NULL DEFAULT 0,   -- Shipment group number (key)
...
LABEL ON TABLE AITSK00030/HYPSGHD IS 'Shipment Group Header';
