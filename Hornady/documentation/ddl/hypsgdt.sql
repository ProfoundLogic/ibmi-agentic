...
-- ============================================================================
CREATE TABLE AITSK00030/HYPSGDT (
  -- Keys (from LFs)
  GDGRP#  DECIMAL(7,0)  NOT NULL DEFAULT 0,   -- Shipment group  (key)
  ...
  GDTURN  DECIMAL(4,0)  NOT NULL DEFAULT 0,   -- Turnaround
  ...
  GDSHPV  CHAR(6)       NOT NULL DEFAULT '',  -- Ship-via
  ...
  -- Lot / pallet / SSCC
  GDSSCC  CHAR(20)      NOT NULL DEFAULT '',  -- SSCC (formatted)
  ...
  GDDVRT  CHAR(2)       NOT NULL DEFAULT '',  -- Shipping lane / divert
  ...
  GDTSEQ  DECIMAL(5,0)  NOT NULL DEFAULT 0,   -- Tote sequence

  -- Labels (HYR0600 GDLBL1 referenced)
  GDLBL1  CHAR(40)      NOT NULL DEFAULT '',  -- Label line 1

  PRIMARY KEY ( GDGRP#, GDTURN, GDITEM, GDORD#, GDORL#, GDBLN#, GDSSCCBC )
) RCDFMT HYRSGDT;

LABEL ON TABLE AITSK00030/HYPSGDT IS 'Shipment Group Detail';
